    ...
    public class SceneSet : ScriptableObject
    {
        ...
        public async void LoadSceneSetAsync(bool additive, float artificialWait, Action<SceneField, int> onSceneLoaded)
        {
            ...
            for(int i = 0, condition = SetScenes.Count; i < condition; i++)
            {
                ...
                await Task.Delay((int)(artificialWait * 1000));
            }
        }
    ...
    public static class AwaitExtensions
    {
        public struct AsyncOperationAwaiter : INotifyCompletion
        {
            ...
            public void OnCompleted(Action action) =>
                op.completed += _ => action();
        }

        public static AsyncOperationAwaiter GetAwaiter(this AsyncOperation r) =>
            new AsyncOperationAwaiter(r);
    }
}